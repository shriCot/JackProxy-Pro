...
<div align="center">
  <img src="https://github.com/user-attachments/assets/c13ded0e-3a63-4987-a912-3f52e6239307" alt="JackProxy Logo" width="800"/>
  <br/>
  <i>高性能 • 高可用 • 易扩展</i>
</div>
...
系统按以下优先级读取Token：命令行参数 > 配置文件 > token.txt文件。
